      ...
      <html className="h-full" dir="ltr" lang={locale} suppressHydrationWarning>
        ...
        >
          <Providers locale={locale}>
            ...
            {/* Main Card Container */}
            <div className="card w-full max-w-3xl min-h-[500px] max-h-[100vh] h-[80vh] bg-white dark:bg-[#232324] shadow-xl border border-base-200 dark:border-slate-700 flex flex-col justify-between overflow-hidden max-sm:rounded-none max-sm:h-full rounded-lg">
              <Header />
